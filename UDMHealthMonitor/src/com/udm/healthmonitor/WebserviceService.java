...
public class WebserviceService {
	...
	private static final String SOAP_ACTION_TEMPERATURE = "http://www.udm.com/TemperatureMeasurementRequest";
	private static final String METHOD_NAME_TEMPERATURE = "temperatureMeasurementRequest";
	...
	public WebserviceResponse sendTemperatureMeasurement(String email, String temperatrue, String scale , String measurementDate, String measurementTime) {

		WebserviceResponse response = new WebserviceResponse();
		SoapObject request = new SoapObject(NAMESPACE, METHOD_NAME_TEMPERATURE);
		addProperty(request, "email", email);
		addProperty(request, "value", temperatrue);
		addProperty(request, "scale", scale);
		addProperty(request, "measurementDate", measurementDate);
		addProperty(request, "measurementTime", measurementTime);

		envelope.setOutputSoapObject(request);

		invokeAndExtractWebServiceResponse(response, SOAP_ACTION_TEMPERATURE);
