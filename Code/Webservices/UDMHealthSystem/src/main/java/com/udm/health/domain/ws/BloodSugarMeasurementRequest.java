...
@XmlRootElement(name = "bloodSugarMeasurementRequest")
public class BloodSugarMeasurementRequest implements RequestClassName{
	...
	public String getRequestClassName() {
		return Service.BLOOD_SUGAR_MEASUREMENT.name();
	}
